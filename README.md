...
## 🚀 НОВИЧОК? → [**НАЧНИТЕ ЗДЕСЬ**](START_HERE.md) ← ВАЖНО!

> **Перед началом разработки обязательно прочитайте [START_HERE.md](START_HERE.md)**
>
> Там объясняется:
> - ✅ Что сделать ПЕРВЫМ (PoC тест)
> - ⚖️ Юридические риски (биометрия!)
> - 🗺️ Выбор стратегии (3 недели vs 8 недель)
> - 📋 Чек-лист готовности
>
> **Сэкономит вам недели разработки!**
...
### ⚠️ ВАЖНО: Прочитайте это перед началом!

**Не торопитесь с разработкой!** Сначала:

1. **Прочитайте [RECOMMENDATIONS.md](RECOMMENDATIONS.md)** - выберите подход (полная разработка vs гибрид vs cloud)
2. **Прочитайте [PRE_DEVELOPMENT_CHECKLIST.md](PRE_DEVELOPMENT_CHECKLIST.md)** - что нужно подготовить
3. **Запустите PoC тест**: `python poc_simple.py --image test.jpg` - убедитесь что ваше железо справится
4. **Получите юридическую консультацию** - система обрабатывает биометрические данные!
...
# 3. Запуск PoC теста (устанавливает зависимости автоматически)
pip install ultralytics insightface opencv-python torch
python poc_simple.py

# Если все тесты прошли ✅ - можете продолжать установку
```

## 💻 Установка (после успешного PoC)
...
### 🚀 Начните отсюда
- ⭐ [**Рекомендации**](RECOMMENDATIONS.md) - выбор стратегии разработки и конфигурации
- ✅ [**Чек-лист подготовки**](PRE_DEVELOPMENT_CHECKLIST.md) - что сделать ДО начала разработки
- 🧪 [**PoC скрипт**](poc_simple.py) - проверка работоспособности на вашем железе

### 📋 Планирование
- 📖 [**План разработки**](DEVELOPMENT_PLAN.md) - детальный план реализации проекта (8 недель)
- 🏛️ [**Архитектура**](ARCHITECTURE.md) - описание архитектуры системы
- 📊 [**Приоритеты задач**](TASK_PRIORITIES.md) - приоритизация разработки (93 задачи)

### 🛠️ Справочники
- ⚡ [**Быстрый старт**](QUICKSTART.md) - шпаргалка по основным командам
- ⚙️ [**.env.example**](.env.example) - пример конфигурации с описаниями
